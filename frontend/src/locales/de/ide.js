export const ide_de = {
    ...
    error_creating_homework: "Fehler beim Erstellen der Hausaufgabe!",
    homework_created_successfully: "Hausaufgabe erfolgreich erstellt.",
    ...
    error_reseting_homework_progress: "Fehler beim Zurücksetzen der Hausaufgabe!",
    ...
    description_of_inconsistencies_when_changing_template: "Du bearbeitest gerade die <u>Vorlage</u> einer Hausaufgabe! Wenn du Änderungen am <b>Code</b> durchführst und speicherst, dann kann dies zu Inkonsistenzen bei den verschiedenen SuS führen: <ul><li>Bei SuS, welche diese Hausaufgabe bereits bearbeiten, werden deine Änderungen <b>nicht ankommen</b>, solange sie ihren Fortschritt nicht löschen und die HA anschließend neu starten.</li><li>SuS, welche diese Hausaufgabe noch nicht gestartet haben, werden beim erstmaligen Öffnen immer den zu diesem Zeitpunkt aktuellsten Code dieser Vorlage verwenden.</li></ul>Änderungen des <b>Titels oder der Projektbeschreibung</b> sind hingegen kein Problem, können jederzeit geändert werden und werden beim Neuladen der IDE bei den SuS aktualisiert.",

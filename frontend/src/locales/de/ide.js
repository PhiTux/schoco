export const ide_de = {
    ...
    no_test_passed: "Ups 🧐 Scheinbar wurde kein einziger Test bestanden! Alle oben gezeigten Tests schlugen fehl.",
    ...
    x_percent_of_tests_passed: "Du hast {percent}% der Tests bestanden. Die obere Ausgabe zeigt alle Tests, die noch NICHT bestanden wurden.",
    ...
    add_new_class: "Neue Klasse hinzufügen",
    description_new_class: "Gib den neuen <b>Namen für die Klasse</b> ein. Denke daran, dass Klassennamen immer mit einem Großbuchstaben beginnen müssen und anschließend nur aus Buchstaben und Zahlen bestehen dürfen (von wenigen Ausnahmen abgesehen)!",
    classname_is_invalid: "Klassenname ist ungültig oder existiert bereits!",
    question_delete_file: "Klasse löschen?",
    ask_delete_class_x: "Möchtest du die Klasse {0} wirklich löschen?",
    ...
    rename_file: "Klasse umbenennen",
    rename_file_description: "Gib den neuen Klassennamen für die Klasse {0} ein.",
    rename_file_description_2: "Denke daran, anschließend den Inhalt der Klasse an den neuen Namen anzupassen!",
    rename_file_invalid: "Dateiname ist ungültig (evtl. enthält er Leerzeichen oder Sonderzeichen oder der Name existiert bereits)!",
    ...
    compile_program: "Programm kompilieren",
    execute_program: "Programm ausführen",
    test_program: "Programm testen",
    compile: "Kompilieren",
    execute: "Ausführen",
    test: "Testen",

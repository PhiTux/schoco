export const login_de = {
    login: "Login",
    register: "Registrieren",
    show_login_error: "Falscher Benutzername oder Passwort",
    registration_only_for_teachers: "Registrierung nur für Lehrkräfte",
    teacher_key: "Lehrer-Passwort",

export const ide_en = {
    ...
    rename_file_description: "Enter the new name for the file {0}. Remember to include the file extension {1}!",
    rename_file_description_2: "The file must always have the same name as the class it contains.",

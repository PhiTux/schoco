export const ide_en = {
    ...
    error_reseting_homework_progress: "Error resetting homework progress!",
    ...
    description_of_inconsistencies_when_changing_template: "You are currently editing the <u>template</u> of a homework! If you make changes to the <b>code</b> and save them, this can lead to inconsistencies among the different students: <ul><li>For students who have already started working on this homework, your changes will <b>not arrive</b> until they delete their progress and start the homework again.</li><li>For students who have not yet started working on this homework, the first time they open it they will always use the latest code of this template.</li></ul>Changes to the <b>title or project description</b>, on the other hand, are not a problem and can be changed at any time and will be updated for the students when they reload the IDE.",

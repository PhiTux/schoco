export const ide_en = {
    ...
    compilation_error: "Internal server-error while compiling! ❌",
    ...
    no_test_passed: "Oops 🧐 Apparently, not a single test was passed! All the tests shown above failed.",
    ...
    x_percent_of_tests_passed: "You passed {percent}% of the tests. The output above shows all the tests that have NOT been passed yet.",
    ...
    description_new_file: "Enter the new <b>name for the class</b>. Remember that class names must always start with a capital letter and can only consist of letters and numbers (with a few exceptions)!",
    classname_is_invalid: "Classname is invalid or the name already exists!",
    question_delete_file: "Delete class?",
    ask_delete_class_x: "Do you really want to delete the class {0}?",
    ...
    rename_file: "Rename class",
    rename_file_description: "Enter the new class name for the class {0}.",
    rename_file_description_2: "Remember to adjust the content of the class to the new name afterwards!",
    rename_file_invalid: "Filename is invalid (it may contain spaces or special characters, or the name already exists)!",

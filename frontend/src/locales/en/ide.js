export const ide_en = {
    ...
    description_new_file: "Enter the new file name for the file. Remember to include the file extension (typically <code>.java</code>)! The Java class within the file must always have the same name as the file itself.",
    create_directory: "Create a directory",
    description_new_file_directory: "If you want to create a directory, you must also specify a file within the new directory. <br><br><b><u>Example:</u></b><br>If you want to create the directory <code>new</code>, you must also specify a file within the directory (e.g. <code>MyClass.java</code>). Therefore, enter the full file name as <code>new/MyClass.java</code>.",

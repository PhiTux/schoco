...
<template>
  <div class="toast-container position-fixed bottom-0 end-0 p-3">
    ...
    <div class="toast text-bg-danger" id="toastErrorAccountsCreated" role="alert" aria-live="assertive" aria-atomic="true"
    ...
    <div class="row">
      <div class="col-3">
        <div class="input-group mb-3">
          ...
          <div class="form-floating">
            <input type="text" id="floatingInputSearchPerson" class="form-control round-right" v-model="state.searchName"
